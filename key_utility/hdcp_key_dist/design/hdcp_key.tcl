...
################################################################
# This is a generated script based on design: hdcp_key
#
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
...
#  -string -flagsOSRD
preplace port rs232_uart -pg 1 -y 400 -defaultsOSRD
preplace port reset -pg 1 -y 270 -defaultsOSRD
preplace port iic_fmc -pg 1 -y 270 -defaultsOSRD
preplace port sys_diff_clock -pg 1 -y 250 -defaultsOSRD
preplace inst axi_iic_0 -pg 1 -lvl 5 -y 290 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 4 -y 280 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 2 -y 70 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 5 -y 410 -defaultsOSRD
...
preplace netloc microblaze_0_Clk 1 1 4 220 130 560 150 1040 420 1350
...
preplace netloc rst_clk_wiz_1_100M_bus_struct_reset 1 2 2 N 200 NJ
preplace netloc microblaze_0_axi_periph_M01_AXI 1 4 1 1340
preplace netloc rst_clk_wiz_1_100M_peripheral_aresetn 1 2 3 NJ 260 1020 430 1360
...
preplace netloc mdm_1_debug_sys_rst 1 1 2 230 10 550
levelinfo -pg 1 0 120 390 800 1190 1470 1600 -top 0 -bot 480
",
}
